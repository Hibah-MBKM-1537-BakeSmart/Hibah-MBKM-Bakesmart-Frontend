...
interface EditAdminModalProps {
    ...
    roles: RoleData[];
    onUpdateAdmin: (adminId: number, data: {
        nama?: string;
        no_hp?: string;
        password?: string;
...
export function EditAdminModal({ isOpen, onClose, admin, roles, onUpdateAdmin }: EditAdminModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto">
            ...
            <div className="relative z-10 w-full max-w-lg rounded-xl bg-white shadow-xl border border-gray-200 m-4 max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-3 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${errors.nama ? 'border-red-500' : 'border-gray-300'
                                    }`}
                    ...
                    {/* Phone Field */}
                    <div>
                        <label htmlFor="edit-noHp" className="block text-sm font-medium text-gray-700 mb-1">
                            Nomor HP *
                        </label>
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-3 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${errors.noHp ? 'border-red-500' : 'border-gray-300'
                                    }`}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                            <div className="flex items-center gap-2">
                                ...
                                Role * <span className="text-xs text-gray-500 font-normal">(bisa pilih lebih dari satu)</span>
                            </div>
                        </label>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full pl-3 pr-10 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${errors.password ? 'border-red-500' : 'border-gray-300'
                                        }`}
