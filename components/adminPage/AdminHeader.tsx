...
export function AdminHeader() {
  ...
  return (
    <header className="shadow-sm border-b px-6 py-4" style={{ backgroundColor: '#f5f1eb', borderColor: '#e0d5c7' }}>
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border z-50" style={{ borderColor: '#e0d5c7' }}>
                <div className="p-4 border-b" style={{ borderColor: '#e0d5c7' }}>
                  <h3 className="text-lg font-medium font-admin-heading" style={{ color: '#5d4037' }}>Notifications</h3>
                </div>
                <div className="max-h-96 overflow-y-auto">
                  {state.notifications.length === 0 ? (
                    <div className="p-4 text-center" style={{ color: '#8b6f47' }}>
                      No notifications
                    </div>
                  ) : (
                      ...
                      >
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            <h4 className="text-sm font-medium font-admin-heading" style={{ color: '#5d4037' }}>
                              {notification.title}
                            </h4>
                          ...
                          {!notification.read && (
                            <div className="w-2 h-2 rounded-full ml-2 mt-1" style={{ backgroundColor: '#8b6f47' }}></div>
                          )}
                        </div>
                      </div>
                    ))
          ...
          <div className="relative">
            ...
            {/* User Dropdown */}
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border z-50" style={{ borderColor: '#e0d5c7' }}>
                <div className="py-1">
                  <button className="flex items-center space-x-3 px-4 py-2 text-sm hover:bg-gray-50 w-full text-left font-admin-body" style={{ color: '#5d4037' }}>
