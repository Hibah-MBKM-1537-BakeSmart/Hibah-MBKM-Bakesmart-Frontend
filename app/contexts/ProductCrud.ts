...
export const {
  ...
  transform: (item: any): Product => ({
    ...
    gambars: Array.isArray(item.gambars) ? item.gambars : [],
    jenis: Array.isArray(item.jenis) ? item.jenis : (item.jenis ? [item.jenis] : []),
    sub_jenis: Array.isArray(item.sub_jenis) ? item.sub_jenis[0] : item.sub_jenis,
